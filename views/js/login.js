        ...
        if(test == true)
        {
            $.ajax({
                ...
                success: function(data){
                    ...
                    {
                        $('#information').css('height',"50px").text("Votre compte a été desactivé").show(500).delay(3000).hide(500)
                    }
                    else
                    {
                        $('#information').css('height',"50px").text(data).show(500).delay(3000).hide(500)
                    }
                },
