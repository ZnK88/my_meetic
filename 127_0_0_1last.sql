...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 29 mars 2020 à 18:26
...
--
-- Base de données :  `my-meetic-bttf`
--
CREATE DATABASE IF NOT EXISTS `my-meetic-bttf` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `my-meetic-bttf`;

-- --------------------------------------------------------

--
-- Structure de la table `account_profil`
--

DROP TABLE IF EXISTS `account_profil`;
CREATE TABLE IF NOT EXISTS `account_profil` (
  ...
  `compte_actif` int(11) NOT NULL DEFAULT '1',
